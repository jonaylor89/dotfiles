...
echo "  5. Set APP_BASE_URL in /srv/infra/.env to your public hub URL"
echo "  6. Set CLOUDFLARE_TUNNEL_TOKEN in /srv/infra/.env"
echo "  7. Build newsletter image: docker build -t email_newsletter:latest <path-to-hub>"
echo "  8. Run: docker compose up -d (from /srv/infra/)"
echo "  9. Run migrations against postgres from the hub repo:"
