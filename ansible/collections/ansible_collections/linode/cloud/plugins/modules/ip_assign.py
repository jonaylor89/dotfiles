...
options:
  assignments:
    ...
    suboptions:
      address:
        description:
        - The IPv4 address or IPv6 range.
        required: true
        type: str
      linode_id:
        description:
...
requirements:
- python >= 3
short_description: 'Assign IPs to Linodes in a given Region. The following restrictions
  apply:  - All Linodes involved must have at least one public IPv4 address after
  assignment.  - Linodes may have no more than one assigned private IPv4 address.  -
  Linodes may have no more than one assigned IPv6 range.'
"""
EXAMPLES = r"""
