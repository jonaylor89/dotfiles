...
description:
- Manage a Linode Token.
- 'NOTE: The full Personal Access Token is only returned when a new token has been
  created.'
module: token
notes: []
options:
...
requirements:
- python >= 3
short_description: 'Manage a Linode Token. NOTE: The full Personal Access Token is
  only returned when a new token has been created.'
"""
EXAMPLES = r"""
