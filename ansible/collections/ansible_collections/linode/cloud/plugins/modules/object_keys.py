...
options:
  access:
    ...
    suboptions:
      ...
      cluster:
        description:
        - The id of the cluster that the provided bucket exists under.
        - '**NOTE: This field has been deprecated because it relies on deprecated
          API endpoints. Going forward, `region` will be the preferred way to designate
          where Object Storage resources should be created.**'
        required: false
        type: str
      permissions:
        choices:
  ...
  regions:
    description:
    - A list of regions to scope this key to.
    elements: str
    required: false
    type: list
  state:
...
requirements:
- python >= 3
short_description: Manage Linode Object Storage Keys.
"""
EXAMPLES = r"""
