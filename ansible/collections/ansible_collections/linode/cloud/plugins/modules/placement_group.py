...
options:
  id:
    description:
    - The unique ID of the placement group.
    required: false
    type: int
  label:
    description:
    - The label of the Placement Group. This field can only contain ASCII letters,
      digits and dashes.
    required: false
    type: str
  placement_group_policy:
  ...
  placement_group_type:
    description:
    - The type of this placement group.
    required: false
    type: str
  region:
    description:
...
requirements:
- python >= 3
short_description: Manage a Linode Placement Group.
"""
EXAMPLES = r"""
