...
options:
  additional_ipv4:
    description:
    - Additional ipv4 addresses to allocate.
    elements: dict
    required: false
    suboptions:
      public:
        description:
        - Whether the allocated IPv4 address should be public or private.
        required: true
        type: bool
    type: list
  authorized_keys:
    ...
    suboptions:
      ...
      devices:
        ...
        suboptions:
          sda:
            description:
            - The device to be mapped to /dev/sda
            required: false
            suboptions:
              disk_id:
                description: &id001
          ...
          sdb:
            description:
            - The device to be mapped to /dev/sdb
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sdc:
            description:
            - The device to be mapped to /dev/sdc
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sdd:
            description:
            - The device to be mapped to /dev/sdd
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sde:
            description:
            - The device to be mapped to /dev/sde
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sdf:
            description:
            - The device to be mapped to /dev/sdf
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sdg:
            description:
            - The device to be mapped to /dev/sdg
            required: false
            suboptions:
              disk_id:
                description: *id001
          ...
          sdh:
            description:
            - The device to be mapped to /dev/sdh
            required: false
            suboptions:
              disk_id:
                description: *id001
      ...
      interfaces:
        description:
        - A list of network interfaces to apply to the Linode.
        - See the [Linode API documentation](https://techdocs.akamai.com/linode-api/reference/post-add-linode-config).
        elements: dict
        required: false
        suboptions:
          ip_ranges:
            description: &id004
            - Packets to these CIDR ranges are routed to the VPC network interface.
              (VPC only)
            elements: str
            required: false
            type: list
          ipam_address:
            description: &id005
            - "This Network Interface\u2019s private IP address in Classless Inter-Domain\
              \ Routing (CIDR) notation."
            required: false
            type: str
          ipv4:
            description: &id006
            - The IPv4 configuration for this interface. (VPC only)
            required: false
            type: dict
          label:
            description: &id007
          ...
          subnet_id:
            description: &id011
            - The ID of the VPC subnet to assign this interface to.
            required: false
            type: int
        type: list
      kernel:
  ...
  disk_encryption:
    ...
    - disabled
    description:
    - 'The disk encryption status of this Linode. NOTE: Disk encryption may not currently
  ...
  disks:
    ...
    suboptions:
      ...
      disk_encryption:
        ...
        - disabled
        description:
        - '**READ ONLY** The disk encryption status of this disk.NOTE: Disk encryption
          may not currently be available to all users and is set at the Linode Level.'
        required: false
        type: str
      filesystem:
        description:
      ...
      stackscript_data:
        ...
        - Only valid when a stackscript_id is provided.
        - See the [Linode API documentation](https://techdocs.akamai.com/linode-api/reference/get-stack-scripts).
        required: false
        type: dict
      stackscript_id:
        description:
  ...
  interfaces:
    description:
    - A list of network interfaces to apply to the Linode.
    - See the [Linode API documentation](https://techdocs.akamai.com/linode-api/reference/post-linode-instance).
    elements: dict
    required: false
    suboptions:
      ip_ranges:
  ...
  placement_group:
    description:
    - A Placement Group to create this Linode under.
    required: false
    suboptions:
      compliant_only:
        default: false
        description:
        - Whether the newly added/migrated/resized linode must be compliant for flexible
          placement groups.
        required: false
        type: bool
      id:
  ...
  rebooted:
    ...
    description:
    - If true, the Linode Instance will be rebooted.
    - 'NOTE: The instance will only be rebooted if it was previously in a running
      state.'
    - To ensure your Linode will always be rebooted, consider also setting the `booted`
      field.
    required: false
    type: bool
  region:
...
requirements:
- python >= 3
short_description: Manage Linode Instances, Configs, and Disks.
"""
EXAMPLES = r"""
