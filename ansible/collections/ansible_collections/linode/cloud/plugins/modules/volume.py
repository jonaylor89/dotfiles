...
options:
  attached:
    default: true
    description:
    - If true, the volume will be attached to a Linode. Otherwise, the volume will
      be detached.
    required: false
    type: bool
  config_id:
    description:
    - When creating a Volume attached to a Linode, the ID of the Linode Config to
      include the new Volume in.
    required: false
    type: int
  encryption:
    choices:
    ...
    - enabled
    description:
    - Enables encryption on the volume. Full disk encryption ensures the data stored
      on a block storage volume drive is secure.
    required: false
    type: str
  label:
    description:
    - "The Volume\u2019s label, which is also used in the filesystem_path of the resulting\
      \ volume."
    required: false
    type: str
  linode_id:
  ...
  source_volume_id:
    description:
    - The volume id of the desired volume to clone.
    required: false
    type: int
  state:
    choices:
  ...
  tags:
    description:
    - The tags to be attached to the volume.
    required: false
    type: list
  wait_timeout:
    default: 240
...
requirements:
- python >= 3
short_description: Manage a Linode Volume.
"""
EXAMPLES = r"""
